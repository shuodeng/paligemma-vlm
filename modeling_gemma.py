...
class KVCache():
    ...
    def update(
        ...
        if len(self.key_cache) <= layer_idx:
            ...
            self.value_cache.append(key_states)
        else:
...
class GemmaConfig():
    ...
    def __init__(
        ...
        intermediate_size,
        num_hidden_layers,
        num_attention_heads, # num of heads for Query in Grouped Multi Head Attention
        num_key_value_heads, # num of heads for Key and Value in Grouped Multi Head Attention
        head_dim=256,
...
class PaliGemmaConfig():
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.is_encoder_decoder = False # Hugging face required config param
        self.pad_token_id = pad_token_id
...
class PaliGemmaForConditionalGeneration(nn.Module):
    def __init__(self, config: PaliGemmaConfig):
        ...
        self.pad_token_id = self.config.pad_token_if if self.config.pad_token_id is not None else -1
